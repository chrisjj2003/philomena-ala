...
<img id="logo" src="../assets/assets/philomena-logo-diap.png">
    <div class="container is-white glow">
        ...
        <form name="medewerker" action="" method="POST" enctype="multipart/form-data" action="">
            <h1>Medewerker Inloggen</h1>
            ...
            <input type="submit" class="submit" name="submit" value="medewerker">
